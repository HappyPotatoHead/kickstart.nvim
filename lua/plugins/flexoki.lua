...
hl('NeoTreeNormalNC', { fg = c.tx2, bg = c.bg2 })
hl('NeoTreeDirectoryName', { fg = c.blue, bold = true })
hl('NeoTreeDirectoryIcon', { fg = c.blue2 })
hl('NeoTreeExpander', { fg = c.tx3 })
hl('NeoTreeFileName', { fg = c.tx })
hl('NeoTreeWinSeparator', { fg = c.ui, bg = c.bg2 })
